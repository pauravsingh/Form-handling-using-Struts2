...
<div class="content">
    ...
    <table class="formtable" align="center">
        ...
        <tr align="center"><td><s:property value="sData.student_id"/></td></tr>
        
        <tr class="field" align="center"><td>NAME</td></tr>
        <tr align="center"><td><s:property value="sData.student_name"/></td></tr>
    
    	<tr class="field" align="center"><td>STREET ADDRESS</td></tr>
        <tr align="center"><td><s:property value="sData.student_address"/></td></tr>
    
    	<tr class="field" align="center"><td>CITY</td></tr>
        <tr align="center"><td><s:property value="sData.student_city"/></td></tr>
    
    	<tr class="field" align="center"><td>STATE</td></tr>
        <tr align="center"><td><s:property value="sData.student_state"/></td></tr>
    
    	<tr class="field" align="center"><td>ZIPCODE</td></tr>
        <tr align="center"><td><s:property value="sData.student_zipcode"/></td></tr>
    
    	<tr class="field" align="center"><td>PHONE NUMBER</td></tr>
        <tr align="center"><td><s:property value="sData.student_phone"/></td></tr>
    
    	<tr class="field" align="center"><td>EMAIL ID</td></tr>
        <tr align="center"><td><s:property value="sData.student_email"/></td></tr>
    
    	<tr class="field" align="center"><td>URL</td></tr>
        <tr align="center"><td><s:property value="sData.student_url"/></td></tr>
    
    	<tr class="field" align="center"><td>DATE OF VISIT</td></tr>
        <tr align="center"><td><s:property value="sData.student_date"/></td></tr>
    
    	<tr class="field" align="center"><td>BEST FEATURES </td></tr>
        <tr align="center"><td><s:property value="sData.gmu_features"/></td></tr>
   
    	<tr class="field" align="center"><td>FOUND COLLEGE VIA</td></tr>
        <tr align="center"><td><s:property value="sData.student_source"/></tr>
    
    	<tr class="field" align="center"><td>GRAD DATE</td></tr>
        <tr align="center"><td><s:property value="sData.student_grad"/></td></tr>
    
    	<tr class="field" align="center"><td>RECOMMEND COLLEGE</td></tr>
        <tr align="center"><td><s:property value="sData.student_recom"/></td></tr>
    
    	<tr class="field" align="center"><td>ANY COMMENTS</tr>
    	<tr align="center"><td><s:property value="sData.student_comments"/></td></tr>
